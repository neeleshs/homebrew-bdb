...
class OpenldapBdb < Formula
  ...
  def install
    ...
    args << "LDFLAGS=\"/usr/local/Cellar/bdb-5.1.29/5.1.29/lib\" CPPFLAGS=\"/usr/local/Cellar/bdb-5.1.29/5.1.29/include\" LD_LIBRARY_PATH=\"/usr/local/Cellar/bdb-5.1.29/5.1.29/lib\""
